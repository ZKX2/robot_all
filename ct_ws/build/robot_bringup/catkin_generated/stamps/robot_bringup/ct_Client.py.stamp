...
import math
from robot_bringup.srv import C_pose,C_poseResponse,C_poseRequest
RED = '\033[91m'
PINK = '\033[95m'
BLUE = '\033[94m'
ENDC = '\033[0m'
...
def  input_param():
    ...
    car_target_pose = [target_x,target_y,target_z,target_theta]
    print(BLUE+"目标3d坐标系和角度:{}".format(car_target_pose)+ENDC)
    req = C_poseRequest()
...
if __name__ == '__main__':
    while True:
        rospy.init_node("Ct_client")
        client = rospy.ServiceProxy("control_Ct", C_pose)
        rospy.wait_for_service("control_Ct")
        input_param()
