...
(cl:in-package turn_on_wheeltec_robot-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <C_pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'C_pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turn_on_wheeltec_robot-srv:<C_pose-request> is deprecated: use turn_on_wheeltec_robot-srv:C_pose-request instead.")))

(cl:ensure-generic-function 'pose_x-val :lambda-list '(m))
(cl:defmethod pose_x-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turn_on_wheeltec_robot-srv:pose_x-val is deprecated.  Use turn_on_wheeltec_robot-srv:pose_x instead.")
  (pose_x m))

(cl:ensure-generic-function 'pose_y-val :lambda-list '(m))
(cl:defmethod pose_y-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turn_on_wheeltec_robot-srv:pose_y-val is deprecated.  Use turn_on_wheeltec_robot-srv:pose_y instead.")
  (pose_y m))

(cl:ensure-generic-function 'pose_z-val :lambda-list '(m))
(cl:defmethod pose_z-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turn_on_wheeltec_robot-srv:pose_z-val is deprecated.  Use turn_on_wheeltec_robot-srv:pose_z instead.")
  (pose_z m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turn_on_wheeltec_robot-srv:theta-val is deprecated.  Use turn_on_wheeltec_robot-srv:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<C_pose-request>)))
  ...
  "turn_on_wheeltec_robot/C_poseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'C_pose-request)))
  "Returns string type for a service object of type 'C_pose-request"
  "turn_on_wheeltec_robot/C_poseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <C_pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'C_pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turn_on_wheeltec_robot-srv:<C_pose-response> is deprecated: use turn_on_wheeltec_robot-srv:C_pose-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <C_pose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turn_on_wheeltec_robot-srv:success-val is deprecated.  Use turn_on_wheeltec_robot-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<C_pose-response>)))
  ...
  "turn_on_wheeltec_robot/C_poseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'C_pose-response)))
  "Returns string type for a service object of type 'C_pose-response"
  "turn_on_wheeltec_robot/C_poseResponse")
