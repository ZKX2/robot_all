...
(cl:in-package unitree_move_base-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <C_pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'C_pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unitree_move_base-srv:<C_pose-request> is deprecated: use unitree_move_base-srv:C_pose-request instead.")))

(cl:ensure-generic-function 'pose_x-val :lambda-list '(m))
(cl:defmethod pose_x-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_move_base-srv:pose_x-val is deprecated.  Use unitree_move_base-srv:pose_x instead.")
  (pose_x m))

(cl:ensure-generic-function 'pose_y-val :lambda-list '(m))
(cl:defmethod pose_y-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_move_base-srv:pose_y-val is deprecated.  Use unitree_move_base-srv:pose_y instead.")
  (pose_y m))

(cl:ensure-generic-function 'pose_z-val :lambda-list '(m))
(cl:defmethod pose_z-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_move_base-srv:pose_z-val is deprecated.  Use unitree_move_base-srv:pose_z instead.")
  (pose_z m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <C_pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_move_base-srv:theta-val is deprecated.  Use unitree_move_base-srv:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<C_pose-request>)))
  ...
  "unitree_move_base/C_poseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'C_pose-request)))
  "Returns string type for a service object of type 'C_pose-request"
  "unitree_move_base/C_poseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <C_pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'C_pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unitree_move_base-srv:<C_pose-response> is deprecated: use unitree_move_base-srv:C_pose-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <C_pose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_move_base-srv:success-val is deprecated.  Use unitree_move_base-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<C_pose-response>)))
  ...
  "unitree_move_base/C_poseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'C_pose-response)))
  "Returns string type for a service object of type 'C_pose-response"
  "unitree_move_base/C_poseResponse")
